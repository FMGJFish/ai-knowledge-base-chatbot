...
// with a valid Supabase Auth session. Navigation to the other admin
// surfaces (Documents, Configuration, Test/Preview, Activity) and Sign Out
// are provided by the shared src/app/admin/layout.tsx nav, not duplicated
// here.
//
// src/proxy.ts already redirects unauthenticated requests before this
// page renders; this server-side check is defense-in-depth, per the
